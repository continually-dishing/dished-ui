    ...
    return (
        <>
            <div style={containerStyles}>
                <div style={leftArrowStyles} onClick={onLeftClick}>&#10094;</div>
                <div style={rightArrowStyles} onClick={onRightClick}>&#10095;</div>
                <div style={slideStyles} onClick={onRightClick} />
                <div style={dotsContainer}>
                    {slides.map((slide, slideIndex) => (
                        <div style={dotStyles} key={slide.title} onClick={() => setCurrentIndex(slideIndex)}>&bull;</div>
                    ))}
                </div>
            </div>
        </>
