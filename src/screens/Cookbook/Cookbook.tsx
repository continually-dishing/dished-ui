...
export default function Cookbook() {
  ...
  function AddIngredient(input: string) {
    if (input !== "") {
      // make sure input isnt empty before adding it in
      setList([...list, input]);
      setInput("");
    }
  }
  ...
  return (
    <div className="cookbook-container">
      ...
      <div className="recipe-container">
        <br />
        <label className="meal-label">Name of meal:</label>
        <br />
        <input id="name" className="meal-input"></input>
        <br />
        <br />
        <label className="meal-label">Difficulty:</label>
        <br />
        ...
        <br />
        <br />
        <label className="meal-label">Prep time:</label>
        <br />
        <input id="prepTime" className="meal-input"></input>
        <br />
        <br />
        <label className="meal-label">Total time:</label>
        <br />
        <input id="totalTime" className="meal-input"></input>
        <br />
        <br />
        <label className="meal-label">Budget Friendly:</label>
        <br />
        ...
        <br />
        <br />
        <label className="meal-label">Vegan:</label>
        <br />
        ...
        <br />
        <br />
        <label className="meal-label">Vegetarian:</label>
        <br />
      ...
      <div className="ingredient-container">
        ...
        ></input>
        <button className="add-button" onClick={() => AddIngredient(input)}>
          &#x2713;
        </button>
